...
| `Верхний колонтитул` | User Task |
| `Body` | Основной текст |
| `BankName1` | Название банка 1 |
| `BankName2` | Название банка 2 |
| `BankName3` | Название банка 3 |
| `Под картинкой 1` | Подпись под картинкой 1 |
| `Под картинкой 2` | Подпись под картинкой 2 |
| `Под картинкой 3` | Подпись под картинкой 3 |
...
Если картинка отсутствует, соответствующие плейсхолдеры автоматически удаляются:

- **Image 2 отсутствует** → удаляется `Image 2` + `BankName2` + `Под картинкой 2`
- **Image 3 отсутствует** → удаляется `Image 3` + `BankName3` + `Под картинкой 3`

### Поддержка колонок Notion

Картинки из блока колонок (column_list) автоматически извлекаются. Можно размещать 3 картинки в 3 колонках — они будут корректно распознаны.
